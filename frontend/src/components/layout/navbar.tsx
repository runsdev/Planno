...
import { FocusModal, FocusTask } from "@/components/focus/focusModal";
    ...
    <>
      ...
      >
        ...
        <Link href="/planner" className="flex items-center gap-1.5 shrink-0">
          ...
          <span className="text-[17px] font-bold italic text-[#4a4a47] tracking-tight">
            planno
          </span>
        </Link>
      ...
      <FocusModal
        ...
        tasks={tasks}
        onMarkComplete={(taskId, totalSeconds) =>
          onMarkComplete?.(taskId, totalSeconds)
        }
        taskProgress={taskProgress}
        onSessionFinished={(taskId, addedSeconds) =>
          onSessionFinished?.(taskId, addedSeconds)
        }
