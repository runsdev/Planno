  ...
  <div className="flex flex-col gap-[10.5px]">
    ...
    <div className="flex items-center gap-[10.5px]">
      <input
        ...
        className="flex-1 h-[41.5px] px-3.5 bg-white border border-[rgba(33,33,33,0.1)] rounded-[10.5px] text-[12.25px] font-normal text-[#212121] outline-none focus:border-[rgba(93,93,90,0.5)]"
      />
